  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-4">
      <a
        ...
        className="group relative bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
      >
        <svg
      ...
      <button
        onClick={scrollToTop}
        className="group relative bg-[#4DA768] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
      >
